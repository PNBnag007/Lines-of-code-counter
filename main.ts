...
const configPath: string = "config.jsonc";
// const inputPath: string = "test_cases\\test.java"; // Replace with your file path
const inputPath: string = "test_cases\\test_dir"; // Replace with your file path
